    			...
    			<div>
    				<paper-card className={styles.post}>
    					<div className={styles.postHeader}>Title here </div>
 						...
 						Leprosy can be cured with a combination of antibiotics. The immune system plays an important role in leprosy and determines if and how the disease will develop.</div>
